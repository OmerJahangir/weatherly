                    ...
                    RichText(text: TextSpan(
                        children: [
                          TextSpan(text: controller.getMinTemp(index),
                            style: TextStyle(color: Colors.grey.withValues(alpha:.5),fontWeight: FontWeight.bold,fontSize: 30),
                          ),
                          TextSpan(text: '/',
                            style: TextStyle(color:Colors.grey.withValues(alpha:.5),fontWeight: FontWeight.bold,fontSize: 25),
                          ),
                          TextSpan(text: controller.getMaxTemp(index),
                            style: TextStyle(color: Colors.grey.withValues(alpha:.5),fontWeight: FontWeight.bold,fontSize: 20),
                          ),
